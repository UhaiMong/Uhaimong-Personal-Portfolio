  ...
  return (
    <>
      ...
      <section id="resume">
        ...
        <div className="px-6 lg:px-16 py-16 flex flex-col items-center text-white">
          {/* Resume Paper */}
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[var(--color-secondary-bg)] w-full rounded-lg shadow-2xl p-8 border border-white/10"
          >
            {/* Download Button */}
